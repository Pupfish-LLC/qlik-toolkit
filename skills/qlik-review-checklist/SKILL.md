...
1. **Script Syntax** (7 items) — Dollar-sign expansion safety, SQL construct prohibition, function arguments, block balance, NullAsValue scope, RENAME collisions, TRACE semicolons.

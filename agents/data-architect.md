...
- **Data Vault source** — Hub/satellite merge strategy per `qlik-data-modeling` → `references/source-consumption-patterns.md`. Flag dual-timestamp incremental needs for satellites. Document hash key construction.
